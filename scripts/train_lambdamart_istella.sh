...
TRAIN_FILE=$ROOT_PATH/train.txt.norm
VALID_FILE=$ROOT_PATH/valid.txt.norm
TEST_FILE=$ROOT_PATH/test.txt.norm
OUTPUT_PATH=$OUTPUT_DIR/lambda_mart.model
java -jar ./ranklib/RankLib-2.12.jar -train $TRAIN_FILE -ranker 6 -validate $VALID_FILE -test $TEST_FILE -save $OUTPUT_PATH -tree 500 -metric2t NDCG@10 -leaf 20
